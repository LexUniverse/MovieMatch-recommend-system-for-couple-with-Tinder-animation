...
film_ids = [117895, 119145, 120466, 122882, 122900, 122902, 122906, 122912, 122916, 122918, 122920, 122924, 122922, 130634, 131739, 133195, 135288, 136556, 136864]
ratings = [5, 5, 5, 4, 5, 3, 5, 5, 4, 4, 5, 4, 5, 4, 3, 4, 3, 4, 4]
...
# Фильтруйте рекомендации по году выпуска
filtered_recommendations = []
for film_index in recommended_films:
    film_id = movies['movieId'].iloc[film_index]
    if film_id in id_to_year and id_to_year[film_id] is not None and id_to_year[film_id] >= 2012:

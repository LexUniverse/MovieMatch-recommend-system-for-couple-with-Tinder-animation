...
movies = pd.read_csv('movies_with_year.csv')

# Преобразуйте матрицу в numpy-массив
data = ratings_matrix.values

# Разделите данные на обучающую и тестовую выборки
train_data_array, test_data_array = train_test_split(data, test_size=0.2, random_state=42, shuffle=False)

# Обучение модели NMF с увеличением max_iter
model = NMF(n_components=50, init='random', max_iter=100, random_state=42)
